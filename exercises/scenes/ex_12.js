      ...
      ">
          ...
          <div style="display:flex;flex-direction:column;align-items:flex-start;gap:0">
            ...
            <div style="position:relative;width:200px;height:40px;margin-bottom:0">
              ...
              <div style="position:absolute;left:70px;display:flex;flex-direction:column;align-items:center;gap:1px">
                <div style="font-size:9px;font-family:monospace;color:#3a5a6a">EVA1</div>
                <div id="sc-pipe-eva1" style="width:14px;height:14px;background:#1a2a1a;border:1px solid #2a3a2a;border-radius:2px;transition:background .2s"></div>
              ...
              <div style="position:absolute;left:170px;display:flex;flex-direction:column;align-items:center;gap:1px">
                <div style="font-size:9px;font-family:monospace;color:#3a5a6a">EVA2</div>
                <div id="sc-pipe-eva2" style="width:14px;height:14px;background:#1a2a1a;border:1px solid #2a3a2a;border-radius:2px;transition:background .2s"></div>
            ...
            <div style="display:flex;align-items:stretch">
              ...
              <div style="position:relative;width:60px;height:200px">
                ...
                <div style="position:absolute;top:16px;right:0;display:flex;align-items:center;gap:3px;justify-content:flex-end">
                  <div style="font-size:8px;font-family:monospace;color:#3a5a3a">I0.2</div>
                  <div id="sc-led-alto" style="width:8px;height:8px;border-radius:50%;background:#1e2a1f;transition:background .15s;flex-shrink:0"></div>
                ...
                <div style="position:absolute;top:96px;right:0;display:flex;align-items:center;gap:3px;justify-content:flex-end">
                  <div style="font-size:8px;font-family:monospace;color:#3a5a3a">I0.1</div>
                  <div id="sc-led-medio" style="width:8px;height:8px;border-radius:50%;background:#1e2a1f;transition:background .15s;flex-shrink:0"></div>
                  <div style="width:10px;height:2px;background:#2a3a2a;flex-shrink:0"></div>
                </div>
                ...
                <div style="position:absolute;top:192px;right:0;display:flex;align-items:center;gap:3px;justify-content:flex-end">
                  <div style="font-size:8px;font-family:monospace;color:#3a5a3a">I0.0</div>
                  <div id="sc-led-bajo" style="width:8px;height:8px;border-radius:50%;background:#1e2a1f;transition:background .15s;flex-shrink:0"></div>
                  <div style="width:10px;height:2px;background:#2a3a2a;flex-shrink:0"></div>
                </div>
              </div>
              ...
              <div style="position:relative;width:140px;height:200px">
                <div style="
                  ...
                  border:3px solid #2a3a2a;border-radius:6px;
                  background:#0d110e;overflow:hidden;
                ">
                ...
                <!-- Líneas guía -->
                <div style="position:absolute;top:20px;left:0;right:0;height:1px;background:#1e2a1f;pointer-events:none"></div>
                <div style="position:absolute;top:100px;left:0;right:0;height:1px;background:#1e2a1f;pointer-events:none"></div>
                <div style="position:absolute;top:196px;left:0;right:0;height:1px;background:#1e2a1f;pointer-events:none"></div>
              </div>
            ...
            <div style="position:relative;width:200px;height:40px">
              <div style="position:absolute;left:120px;display:flex;flex-direction:column;align-items:center;gap:1px">
                <div id="sc-pipe-eva3" style="width:14px;height:14px;background:#1a2a1a;border:1px solid #2a3a2a;border-radius:2px;transition:background .2s"></div>
                <div style="font-size:9px;font-family:monospace;color:#3a5a6a">EVA3</div>
          ...
          <div style="display:flex;flex-direction:column;gap:16px;padding-top:40px">
            ...
            <div style="display:flex;flex-direction:column;gap:12px">
              ...
              <div style="display:flex;align-items:center;gap:10px">
                <div id="sc-btn-iniciar" style="width:44px;height:44px;border-radius:50%;background:#1a2a1a;border:3px solid #2a3a2a;display:flex;align-items:center;justify-content:center;cursor:pointer;box-sizing:border-box;transition:transform .08s">
                ...
                <div>
                  <div style="font-size:10px;font-family:monospace;color:#4a6a4a">Iniciar mezcla</div>
              ...
              <div style="display:flex;align-items:center;gap:10px">
                <div id="sc-btn-abrir" style="width:44px;height:44px;border-radius:50%;background:#1a2a1a;border:3px solid #2a3a2a;display:flex;align-items:center;justify-content:center;cursor:pointer;box-sizing:border-box;transition:transform .08s">
                ...
                <div>
                  <div style="font-size:10px;font-family:monospace;color:#4a6a7a">Abrir EVA3</div>
              ...
              <div style="display:flex;align-items:center;gap:10px">
                <div id="sc-btn-cerrar" style="width:44px;height:44px;border-radius:50%;background:#2a1a1a;border:3px solid #3a2a2a;display:flex;align-items:center;justify-content:center;cursor:pointer;box-sizing:border-box;transition:transform .08s">
            ...
            <div style="display:flex;flex-direction:column;gap:5px;padding:8px;border:1px solid #1e2a1f;border-radius:6px">
              <div style="font-size:9px;font-family:monospace;color:#2a4a2a;letter-spacing:.08em;margin-bottom:2px">ELECTROVÁLVULAS</div>
              <div style="display:flex;align-items:center;gap:6px">
                <div id="sc-led-eva1" style="width:8px;height:8px;border-radius:50%;background:#1e2a1f;transition:background .15s"></div>
                <span style="font-size:10px;font-family:monospace;color:#3a4a3a">Q0.0 · EVA1</span>
              </div>
              <div style="display:flex;align-items:center;gap:6px">
                <div id="sc-led-eva2" style="width:8px;height:8px;border-radius:50%;background:#1e2a1f;transition:background .15s"></div>
                <span style="font-size:10px;font-family:monospace;color:#3a4a3a">Q0.1 · EVA2</span>
              </div>
              <div style="display:flex;align-items:center;gap:6px">
                <div id="sc-led-eva3" style="width:8px;height:8px;border-radius:50%;background:#1e2a1f;transition:background .15s"></div>
                <span style="font-size:10px;font-family:monospace;color:#3a4a3a">Q0.2 · EVA3</span>
              </div>
            </div>

            <div id="sc-status" style="font-size:10px;font-family:monospace;color:#3a4a3a;letter-spacing:.06em;padding:6px 10px;border:1px solid #1e2a1f;border-radius:4px;max-width:160px;line-height:1.4">SISTEMA EN ESPERA</div>
        ...
        <div style="display:flex;gap:14px;flex-wrap:wrap;justify-content:center">
          <div style="display:flex;align-items:center;gap:5px">
            ...
            <span style="font-size:9px;color:#4a5a6a;font-family:monospace">I0.0–I0.2 · Sensores automáticos</span>
          </div>
          <div style="display:flex;align-items:center;gap:5px">
            <div style="width:8px;height:8px;border-radius:50%;background:#2a8a2a"></div>
            <span style="font-size:9px;color:#4a5a4a;font-family:monospace">Componente A (verde)</span>
          </div>
          <div style="display:flex;align-items:center;gap:5px">
            <div style="width:8px;height:8px;border-radius:50%;background:#1a6a8a"></div>
            <span style="font-size:9px;color:#4a5a6a;font-family:monospace">Componente B (azul)</span>
          </div>
        </div>
